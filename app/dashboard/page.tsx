  ...
  <div className="fixed inset-0 bg-[#1b1b1b]/50 backdrop-blur-sm z-50 flex justify-center items-center p-4">
    <div className="w-full max-w-2xl bg-white border-2 border-[#1b1b1b] rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
      <div className="bg-[#1b1b1b] px-6 py-4 flex justify-between items-center shrink-0">
        ...
        <button onClick={() => setShowEmailHelp(false)} className="p-1 text-white hover:bg-white/20 rounded-full transition">
          <X className="w-4 h-4" />
        </button>
      </div>
      ...
      <div className="overflow-y-auto p-6 space-y-5 font-sans text-xs bg-[#FCFBF8] text-[#1b1b1b] leading-relaxed">
        ...
        <div>
          <h4 className="font-black text-sm text-[#1b1b1b] mb-1.5 uppercase tracking-wide">(A1) RISK ASSESSMENT</h4>
          <p className="text-zinc-600 font-medium">
            The email sent out can be formatted or plain text. Plain text option is preferred to minimize the outbound email data packet size.
          </p>
        </div>
        ...
        <div className="border-t border-zinc-200 pt-4">
          <h4 className="font-black text-sm text-[#1b1b1b] mb-1.5 uppercase tracking-wide">HOW TO :-</h4>
          <div className="bg-zinc-50 p-4 rounded-xl font-mono text-[11px] border border-zinc-200 space-y-2">
            <div><strong className="text-zinc-800">TO :</strong> hello@logmark-ai.com</div>
            <div>
              <strong className="text-zinc-800">SUBJECT :</strong> Enter the name of the module you want to query. Please ensure that you use one of the following: <span className="bg-zinc-200 px-1 rounded">"RA"</span>, <span className="bg-zinc-200 px-1 rounded">"RISK ASSESSMENT"</span>, <span className="bg-zinc-200 px-1 rounded">"SAFETY ASSESSMENT"</span>, or <span className="bg-zinc-200 px-1 rounded">"RISK ANALYSIS"</span>. <span className="italic text-zinc-500">Please note that the MATE ‘may not’ reliably process or recognize keywords outside of this list.</span>
            </div>
            <div>
              <strong className="text-zinc-800">BODY :</strong> Insert a one liner query to the risk assessment module.
              <p className="mt-1.5 font-sans text-zinc-600 text-xs">In a separate paragraph, spaced by a line, put in list of items you want the AI to mandatorily include in your risk assessment output.</p>
            </div>
            <div>
              <strong className="text-zinc-800">ATTACHMENT :</strong> Any PDF relevant to the RA being generated can be added as an attachment; example – mail from office requiring points to be included in RA, extract of company manual or any other document that as relevant information that you want included in the risk assessment generated.
            </div>
          </div>
          <p className="mt-2 text-zinc-500 italic">Note that; additional text after the RA request and attachment addition are optional.</p>
        </div>

        <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl space-y-1">
          <span className="block font-black text-amber-900 uppercase text-[10px] tracking-wider">!! Pro-Tip for Best Results:</span>
          <p className="text-amber-800 font-medium">
            Greater the detail mentioned in the requirement, the better will the output.
          </p>
          <p className="text-amber-700 font-mono text-[11px] pt-1">
            <span className="block text-red-700/80">❌ Poor: “Make RA for ‘midship crane not operating prior coming to port’”</span>
            <span className="block text-emerald-800 mt-0.5">✅ Better: ‘Midship crane non-operational as required by terminal requirement prior vessel coming into terminal for loading operation’</span>
          </p>
        </div>

        <div className="border-t border-zinc-200 pt-4">
          <h4 className="font-black text-sm text-[#1b1b1b] mb-1.5 uppercase tracking-wide">EXAMPLE :-</h4>
          <div className="bg-zinc-900 text-zinc-100 p-4 rounded-xl font-mono text-[11px] space-y-2.5 shadow-inner">
            <div><span className="text-zinc-400">TO :</span> hello@logmark-ai.com</div>
            <div><span className="text-zinc-400">SUBJECT :</span> Risk Assessment</div>
            <div>
              <span className="text-zinc-400">BODY :</span> 
              <p className="text-white mt-1">Make a RA for X-band RADAR not working.</p>
              <p className="text-white mt-3">Inform flag and class, obtain dispensation</p>
            </div>
            <div className="pt-1.5 border-t border-zinc-800 text-zinc-400">
              <span>ATTACHMENT :</span> <span className="text-amber-400">eMail.pdf</span> <span className="text-zinc-500 italic">“(mail from office requesting RA to be made and points to be included)”</span>
            </div>
          </div>
        </div>

        <p className="text-[11px] text-zinc-500 font-medium pt-2 border-t border-zinc-100">
          ## Note :- Pls read the workflow at the bottom of this document on how MATE generated the required response.
        </p>
