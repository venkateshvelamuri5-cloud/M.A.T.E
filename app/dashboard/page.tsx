...
export default function UserDashboard() {
  ...
  const DEFAULT_USER_MANUAL = `M.A.T.E User Manual\n\n(for email Query)\n\nModules Available\n(A) ISM ADMIN WORKS\nA1 - Risk Assessment\nA2 - Audit Closure (work in progress)\nA3 - Drill Notes (work in progress)\nA4 - Training Minutes (work in progress)\n(B) ACCOUNTING & PAYROLL\nB1 - Payroll Calculation (work in progress)\nB2 - Vessel Accounts (Including Welfare a/c) (work in progress)\nB3 - Bond Accounting (work in progress)\nB4 - Victualling Accounting (work in progress)\n(C) CREW RELATED\nC1 - Port Papers (work in progress)\nC2 - Crew Certification (work in progress)\nC3 -\nC4 -\n(D) CARGO RELATED (Tankers)\nD1 - Voyage Orders, Simplified (work in progress)\nD2 - Cargo Calculations (work in progress)\nD3 -\nD4 -\n(E) INVENTORIES\nE1 - Ship's Library (work in progress)\nE2 - Ship’s Certificates (work in progress)\nE3 – Medicine Chest (work in progress)\nE4 – Narcotics List (work in progress)\n(F) MISC, ADDITIONAL\nF1 – SMS Clarification (Using AI)\nF2 – Weather Reports\nF3 – SIRE 2.0\nF4 – General Maritime AI Query\n(A1) RISK ASSESSMENT\n\nThe email sent out can be formatted or plain text. Plain text option is preferred to minimize\nthe outbound email data packet size.\n----------------------------------------------------\nHOW TO :-\nTO : mate@logmark-ai.com\nSUBJECT : Enter the name of the module you want to query. Please ensure that you use one\nof the following: "RA", "RISK ASSESSMENT", "SAFETY ASSESSMENT", or "RISK ANALYSIS".\nPlease note that the MATE ‘may not’ reliably process or recognize keywords outside of this\nlist.\nBODY : Insert a one liner query to the risk assessment module.\nIn a separate paragraph, spaced by a line, put in list of items you want the AI to mandatorily\ninclude in your risk assessment output.\nATTACHMENT : Any PDF relevant to the RA being generated can be added as an attachment;\nexample – mail from office requiring points to be included in RA, extract of company manual\nor any other document that as relevant information that you want included in the risk\nassessment generated.\nNote that; additional text after the RA request and attachment addition are optional.\n!! Greater the detail mentioned in the requirement, the better will the output”\nFor example :- A query “Make RA for ‘midship crane not operating prior coming to port’” will\ngive a poor result compared to ‘Midship crane non-operational as required by terminal\nrequirement prior vessel coming into terminal for loading operation’\n----------------------------------------------------\n----------------------------------------------------\nEXAMPLE :-\nTO : mate@logmark-ai.com\nSUBJECT : Risk Assessment\nBODY :\nMake a RA for X-band RADAR not working.\nInform flag and class, obtain dispensation\nATTACHMENT : eMail.pdf “(mail from office requesting RA to be made and points to be\nincluded)”\n----------------------------------------------------\n## Note :- Pls read the workflow at the bottom of this document on how MATE generated\nthe required response.\n\n## ABOUT THE WORKFLOW.\nUnderstanding the AI workflow allows for the creation of a tailored response that is highly\naccurate and specific to both you and your vessel type.\nThe M.A.T.E. workflow operates as follows:\nStep 1: M.A.T.E. receives your input and any additional information provided in the same\nquery.\nStep 2: M.A.T.E. reviews any attachments included with your query.\nStep 3: M.A.T.E. references your user settings to curate a response specific to your\nconfiguration.\nStep 4: Where relevant, M.A.T.E. references company manuals from your downloads section\nto incorporate company-specific details into the generated response.\n\nNote: Please monitor your token usage, as processing or reviewing detailed\nmanuals can consume a significant amount of your available tokens.\n\nxxx END xxx`;
